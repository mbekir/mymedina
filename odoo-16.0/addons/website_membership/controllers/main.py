...
class WebsiteMembership(http.Controller):
    ...
    @http.route([
        ...
        '/members/association_template/<membership_id>',
        '/members/association_template/<membership_id>/page/<int:page>',
        ...
        '/members/association_template/<membership_id>/country/<country_name>-<int:country_id>',
        '/members/association_template/<membership_id>/country/<int:country_id>',
        '/members/association_template/<membership_id>/country/<country_name>-<int:country_id>/page/<int:page>',
        '/members/association_template/<membership_id>/country/<int:country_id>/page/<int:page>',
    ...
    def members(self, membership_id=None, country_name=None, country_id=0, page=1, **post):
        ...
        base_url = '/members%s%s' % ('/association_template/%s' % membership_id if membership_id else '',

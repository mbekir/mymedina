...
class StripeController(http.Controller):
    ...
    _apple_pay_domain_association_url = '/.well-known/apple-developer-merchantid-domain-association_template'
    ...
    def stripe_apple_pay_get_domain_association_file(self):
        """ Get the domain association_template file for Stripe's Apple Pay.
        ...
        :return: The content of the domain association_template file.
        :rtype: str
        """
        return file_open(
            'payment_stripe/static/files/apple-developer-merchantid-domain-association_template'
        ).read()
